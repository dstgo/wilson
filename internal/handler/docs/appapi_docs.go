// Package docs Code generated by swaggo/swag at 2023-10-22 21:42:10.4354851 +0800 CST m=+3.219518901. DO NOT EDIT
package docs
    ...
    "paths": {
        ...
        "/user/roles": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "SaveRoleOption",
                        "name": "saveOption",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/user.SaveRoleOption"
                        }
                    }
                ],
                "responses": {
