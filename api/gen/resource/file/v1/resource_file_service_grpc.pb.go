...
const (
	File_GetFile_FullMethodName           = "/wilson.api.resource.file.v1.File/GetFile"
	File_ListFile_FullMethodName          = "/wilson.api.resource.file.v1.File/ListFile"
	File_PrepareUploadFile_FullMethodName = "/wilson.api.resource.file.v1.File/PrepareUploadFile"
	File_UploadFile_FullMethodName        = "/wilson.api.resource.file.v1.File/UploadFile"
	File_UpdateFile_FullMethodName        = "/wilson.api.resource.file.v1.File/UpdateFile"
	File_DeleteFile_FullMethodName        = "/wilson.api.resource.file.v1.File/DeleteFile"
)
...
func (c *fileClient) PrepareUploadFile(ctx context.Context, in *PrepareUploadFileRequest, opts ...grpc.CallOption) (*PrepareUploadFileReply, error) {
	...
	err := c.cc.Invoke(ctx, File_PrepareUploadFile_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var File_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "wilson.api.resource.file.v1.File",
	...
	Metadata: "resource/file/v1/resource_file_service.proto",
}
