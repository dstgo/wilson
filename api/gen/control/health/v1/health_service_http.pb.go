...
const OperationHealthCheck = "/wilson.api.control.health.v1.Health/Check"
...
func RegisterHealthHTTPServer(s *http.Server, srv HealthHTTPServer) {
	r := s.Route("/")
	r.GET("/control/v1/health/check", _Health_Check1_HTTP_Handler(srv))
}

func _Health_Check1_HTTP_Handler(srv HealthHTTPServer) func(ctx http.Context) error {
...
func (c *HealthHTTPClientImpl) Check(ctx context.Context, in *emptypb.Empty, opts ...http.CallOption) (*emptypb.Empty, error) {
	...
	pattern := "/control/v1/health/check"
