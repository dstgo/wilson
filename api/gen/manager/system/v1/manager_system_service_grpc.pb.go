...
const (
	System_GetSystemSetting_FullMethodName = "/wilson.api.manager.system.v1.System/GetSystemSetting"
)
...
func (c *systemClient) GetSystemSetting(ctx context.Context, in *GetSystemSettingRequest, opts ...grpc.CallOption) (*GetSystemSettingReply, error) {
	...
	err := c.cc.Invoke(ctx, System_GetSystemSetting_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var System_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "wilson.api.manager.system.v1.System",
	...
	Metadata: "manager/system/v1/manager_system_service.proto",
}
