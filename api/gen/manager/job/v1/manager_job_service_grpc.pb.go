...
const (
	Job_ListJob_FullMethodName   = "/wilson.api.manager.job.v1.Job/ListJob"
	Job_CreateJob_FullMethodName = "/wilson.api.manager.job.v1.Job/CreateJob"
	Job_UpdateJob_FullMethodName = "/wilson.api.manager.job.v1.Job/UpdateJob"
	Job_DeleteJob_FullMethodName = "/wilson.api.manager.job.v1.Job/DeleteJob"
)
...
func (c *jobClient) ListJob(ctx context.Context, in *ListJobRequest, opts ...grpc.CallOption) (*ListJobReply, error) {
	...
	err := c.cc.Invoke(ctx, Job_ListJob_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var Job_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "wilson.api.manager.job.v1.Job",
	...
	Metadata: "manager/job/v1/manager_job_service.proto",
}
