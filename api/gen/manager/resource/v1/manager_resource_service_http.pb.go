...
func RegisterResourceHTTPServer(s *http.Server, srv ResourceHTTPServer) {
	r := s.Route("/")
	r.GET("/manager/api/v1/resource", _Resource_GetResource1_HTTP_Handler(srv))
	r.PUT("/manager/api/v1/resource/{keyword}", _Resource_UpdateResource1_HTTP_Handler(srv))
}
...
func _Resource_UpdateResource1_HTTP_Handler(srv ResourceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
