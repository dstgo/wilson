...
const OperationHealthCheck = "/wilson.api.game.health.v1.Health/Check"
...
func RegisterHealthHTTPServer(s *http.Server, srv HealthHTTPServer) {
	r := s.Route("/")
	r.GET("/game/v1/health/check", _Health_Check3_HTTP_Handler(srv))
}

func _Health_Check3_HTTP_Handler(srv HealthHTTPServer) func(ctx http.Context) error {
