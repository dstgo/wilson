...
const (
	Business_ListBusiness_FullMethodName        = "/wilson.api.configure.business.v1.Business/ListBusiness"
	Business_CreateBusiness_FullMethodName      = "/wilson.api.configure.business.v1.Business/CreateBusiness"
	Business_UpdateBusiness_FullMethodName      = "/wilson.api.configure.business.v1.Business/UpdateBusiness"
	Business_DeleteBusiness_FullMethodName      = "/wilson.api.configure.business.v1.Business/DeleteBusiness"
	Business_ListBusinessValue_FullMethodName   = "/wilson.api.configure.business.v1.Business/ListBusinessValue"
	Business_UpdateBusinessValue_FullMethodName = "/wilson.api.configure.business.v1.Business/UpdateBusinessValue"
)
...
func (c *businessClient) ListBusiness(ctx context.Context, in *ListBusinessRequest, opts ...grpc.CallOption) (*ListBusinessReply, error) {
	...
	err := c.cc.Invoke(ctx, Business_ListBusiness_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *businessClient) ListBusinessValue(ctx context.Context, in *ListBusinessValueRequest, opts ...grpc.CallOption) (*ListBusinessValueReply, error) {
	...
	err := c.cc.Invoke(ctx, Business_ListBusinessValue_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *businessClient) UpdateBusinessValue(ctx context.Context, in *UpdateBusinessValueRequest, opts ...grpc.CallOption) (*UpdateBusinessValueReply, error) {
	...
	err := c.cc.Invoke(ctx, Business_UpdateBusinessValue_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var Business_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "wilson.api.configure.business.v1.Business",
	...
	Metadata: "configure/business/v1/configure_business_service.proto",
}
