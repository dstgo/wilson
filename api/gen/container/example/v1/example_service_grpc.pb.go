...
const (
	Example_Hello_FullMethodName = "/wilson.api.container.example.v1.Example/Hello"
)
...
func (c *exampleClient) Hello(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (UnimplementedExampleServer) Hello(context.Context, *emptypb.Empty) (*emptypb.Empty, error) {
...
func _Example_Hello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ExampleServer).Hello(ctx, req.(*emptypb.Empty))
	}
...
var Example_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "wilson.api.container.example.v1.Example",
	...
	Metadata: "container/example/v1/example_service.proto",
}
